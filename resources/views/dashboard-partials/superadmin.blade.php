...
{{-- ========================================================== --}}
{{-- --- 🔥 INI DIA TAMBAHAN "KELOLA RAK" BARU 🔥 --- --}}
{{-- ========================================================== --}}
<a class="nav-item" href="{{ route('admin.superadmin.shelves.index') }}">

<div class="nav-item-main"><span>Kelola Rak</span></div>
<span class="meta">Lokasi & Penempatan Buku</span>
</a>
{{-- ========================================================== --}}
