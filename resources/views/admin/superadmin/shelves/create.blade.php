...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Tambah Rak Baru</h1>
...
<!-- Form Tambah Rak (Versi Sederhana) -->
<div class="bg-white shadow-xl rounded-lg overflow-hidden">
    <div class="p-6">
        ...
        <form action="{{ route('admin.superadmin.shelves.store') }}" method="POST">
            @csrf
