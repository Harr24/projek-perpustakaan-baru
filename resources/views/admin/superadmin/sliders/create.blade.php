                ...
                <div class="card-body">
                    <form action="{{ route('admin.superadmin.sliders.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Rekomendasi ukuran: 1920x1080px. Maksimal 2MB.</div>
                            @error('image_path')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" id="link_url" name="link_url" value="{{ old('link_url') }}" class="form-control @error('link_url') is-invalid @enderror" placeholder="https://contoh.com">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="order" name="order" value="{{ old('order', 0) }}" class="form-control @error('order') is-invalid @enderror" style="max-width: 150px;">
