            ...
            <tr class="{{ $isOverdue ? 'table-danger' : '' }}">
                ...
                <td class="px-3">
                    <div class="d-flex align-items-center">
                        <span class="me-3">{{ $borrow->user->name }}</span>
...
@push('scripts')
{{-- ========================================================== --}}
{{-- ===== JAVASCRIPT BARU: Diadaptasi dari APPROVALS ===== --}}
{{-- ========================================================== --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const csrfToken = bulkReturnForm.querySelector('input[name="_token"]').value;
