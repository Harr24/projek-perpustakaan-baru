...
<body>
          ...
          <div class="card-body">
            <form action="{{ route('admin.petugas.books.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
              ...
              <div class="row g-3 align-items-center mb-3">
                ...
                <div class="col-6 col-md-3 preview-col text-center">
      ...
      <div class="col-lg-4">
        <div class="card sidebar-card mb-3">
          <div class="card-body">
            ...
            <p class="mb-0 text-muted">Pastikan genre dipilih agar buku mudah difilter di katalog.</p>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="mb-0">
              <li class="mb-1">Isi semua field wajib yang ditandai bintang.</li>
              <li class="mb-1">Gunakan sampul yang jelas untuk memudahkan identifikasi.</li>
              <li class="mb-1">Periksa stok agar data inventaris akurat.</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <script>
    // preview cover image (mobile-friendly)
    ...
    // simple client-side validation feedback (Bootstrap)
    (function () {
      'use strict'
